...
public class ListView<T> extends CustomPanel
{
	...
	private JPanel getActionPanel()
	{
		...
		showBtn.addActionListener((ignored) -> MainFrameSteuerung.getInstance()
				.openUebersicht(getCurrentObject()));
		panel.add(showBtn);
		...
		deleteBtn.addActionListener((ignored) -> {
			...
			catch (Exception ig)
			{
				JOptionPane.showMessageDialog(this,
						"Fehler beim loeschen der Vokabel");
			}
	...
	private T getCurrentObject()
	{
		...
		return model.getObjectForRow(sorter != null
